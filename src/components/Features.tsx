...
<div className='flex flex-col sm:flex-row gap-8 '>
    <div className='flex flex-col gap-2'>
        ...
        <p className=''>Free delivery on all orders over €200 and over €100 for Europe.</p>
    </div>
    <div className='flex flex-col gap-2'>
        ...
        <p className=''>Certified partners and data protection for the best experience possible.</p>
    </div>
    <div className='flex flex-col gap-2'>
        ...
        <p className=''>Any questions? Head over to our support. We're here to help.</p>
    </div>
</div>
    </section>
  )
